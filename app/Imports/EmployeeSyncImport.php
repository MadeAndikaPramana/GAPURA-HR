...
class EmployeeSyncImport extends BaseExcelImport
{
    ...
    {
        return [
            // Excel header => internal field mapping
            'NIP' => 'nip',
            'nip' => 'nip',
            'employee_id' => 'nip',
            'Nama Lengkap' => 'name',
            ...
            'alamat' => 'address',
            'address' => 'address',
            'Status Pegawai' => 'employee_status',
    ...
    public function rules(): array
    {
        return [
            ...
            '*.No. HP' => 'sometimes|string|max:20',
            '*.Tanggal Masuk' => 'sometimes|date',
            '*.Tanggal Lahir' => 'sometimes|date',
            '*.Tempat Lahir' => 'sometimes|string|max:255',
            '*.Jenis Kelamin' => 'sometimes|string|in:Laki-laki,Perempuan,male,female,laki-laki,perempuan,l,p,m,f',
            '*.Alamat' => 'sometimes|string|max:500',
            '*.Status Pegawai' => 'sometimes|string|in:permanent,contract,intern,temporary',
            '*.Status Aktif' => 'sometimes|string|in:Aktif,Nonaktif,active,inactive',
            '*.Pendidikan' => 'sometimes|string|max:255',
            '*.Status Pernikahan' => 'sometimes|string|max:100',
            '*.Agama' => 'sometimes|string|max:100',
            '*.Kewarganegaraan' => 'sometimes|string|max:100',
