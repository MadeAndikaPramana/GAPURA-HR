...
export default function Edit({ auth, trainingType }) {
    ...
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Edit Training Type</h2>}
        >
            <Head title="Edit Training Type" />
